...
fetchCategories();
fetchProducts();
function renderMenu(categorys) // -> done
{
    let categoryHtml = ``;
...
function showBestSaleProducts (listItems) // -> render list products best sale
{
...
function ShowProductsOfInterest (listItems) // render list products of interest
{
