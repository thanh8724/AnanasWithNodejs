function renderCart() {
    ...
    itemHtml += `<tr class="table__cart--tbody-tr">
                        <td class="tbody-td--infoProduct">
                            ...
                            <div class="box__info--product-cart">
                                ...
                                <span class="price__product">${formatMoney(
                                  strToNumber(product.price)
                                )}<span class=""> VNĐ</span></span>
                                <span class="size__product">Size:${
                                  product.sizeProduct
                                }</span>
                            </div>
                        </td>
                        <td class="tbody-td">
                            <div class="box_quantity-size-content">
                                ...
                                <input class="input_quantityProduct" type="number" min="1" max="10" value="${
                                  product.quantity
                                }">
  ...
  function renderBoxLeftCart() {
    ...
    document.querySelector(
      ".main__info--bottom"
    ).innerHTML = `<div class="info--bottom-container">
  ...
  document.querySelector(
    ".main__section--title"
  ).innerHTML = `<span class="title__cart">GIỎ HÀNG / </span>
...
function changeQuantity() {
  ...
  subtractionButton.forEach((button) => {
    let newQuantity = 0;
    button.onclick = (e) => {
      const inputQuantity = e.target.parentElement.querySelector(
