...
class HandleCart {
    valueCartFromStorage: itemCart[];
    constructor(valueCartFromStorage: itemCart[]) {
        this.valueCartFromStorage = valueCartFromStorage;
    }
    renderCart = (): void => {
        let HtmlShow: string = '';
        this.valueCartFromStorage.forEach(element => {
            let priceProduct: number = Number(element.price) * Number(element.quantity);
            HtmlShow += `
        ...
        const tbodyShow: HTMLElement | null = document.querySelector(".table__cart--tbody");
        const headerCart: HTMLElement | null = document.querySelector(".main__section--title");
    ...
    renderInfoCart = (): void => {
        const containerShow: HTMLElement|null = document.querySelector(".main__info--bottom");
    ...
    deleteProduct = (): void => {
        const deleteProductButtons: NodeListOf<HTMLElement> = document.querySelectorAll(".delete");
    ...
    handleRenderCart = (): void => {
        const cart__empty: HTMLSelectElement | null = document.querySelector(".cart__empty");
        const mainCarts: NodeListOf<Element> | null = document.querySelectorAll(".mainCart");
