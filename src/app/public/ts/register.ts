...
const registerForm: HTMLFormElement | null = document.querySelector(".form__register");
if(registerForm) {
    registerForm.onsubmit = async (event) => {
        ...
        if (response.status === 400) {
            ...
            const container: HTMLDivElement | null = document.querySelector(".container__main");
            if(container) {
