...
function addToCart() {
    ...
    addcart.forEach((element) => {
        element.onclick = (e) => {
            ...
            const idCategory = containerProduct.querySelector(".idCategory").innerText;
            ...
            const nameProduct = containerProduct.querySelector(".name__product").textContent;
            let quantityProduct = 1;
            const priceProduct = containerProduct.querySelector(".price__product").innerText;
            ...
            let indexExistingProduct = arrayProduct.reduce((acc, product, indexProduct) => {
            ...
            if (indexExistingProduct.length == 0) {
                ...
                indexExistingProduct.forEach((index) => {
                    let newQuantity = parseInt(arrayProduct[index].quantity) + parseInt(quantityProduct);
...
function addToCart2(data, idProduct) {
    ...
    if (buttonAddToCart) {
        buttonAddToCart.onclick = () => {
            ...
            let quantityProduct = document.querySelector(".input_quantityProduct").value;
